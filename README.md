...
A calm, practical reference app for the DCS, Census and Avance work transition.
...
The app is static and has no build dependencies.
...
The original planning notes remain in `_DCS Census Avance work plan.txt`.
